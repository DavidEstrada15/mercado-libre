...
<div className=' lg:bottom-40 lg:left-0 lg:relative   overflow-hidden'>
      ...
      <article style={user != null ? {display: "none"}: {display: "flex"}} className='bg-white lg:max-w-[20vw] lg:h-[45vh] px-10 py-1 lg:px-0 lg:py-0 rounded-2xl flex flex-col gap-2 text-center '>
       <h2 className=' hidden lg:flex'>Ingresa a tu cuenta</h2>
        ...
        <div>
          ...
          <h2>Disfruta de ofertas <br /> y compras sin limites</h2>
        </div>
    ...
    <article className='bg-white lg:max-w-[20vw] lg:h-[45vh] px-10 py-1 lg:px-0 lg:py-0 rounded-2xl flex flex-col gap-2 text-center '>
        ...
        <div>
          ...
          <h2>Descubre productos <br /> con precios bajos</h2>
        </div>
      ...
      <article className='bg-white lg:max-w-[20vw] lg:h-[45vh] px-10 py-1 lg:px-0 lg:py-0 rounded-2xl flex flex-col gap-2 text-center '>
        ...
        <div>
          ...
          <h2>Realiza tu compra gratis <br /> de forma totalmente segura</h2>
        </div>
        <Link to={"/PQRpage"} state={"Compras"}>
        <button className='bg-blue-200 cursor-pointer text-blue-600 place-self-center text-[0.9rem] px-2 rounded-[10%] py-2 '>Como funciona</button></Link>
      </article>
